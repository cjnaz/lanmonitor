...
#         {'key':'Interface_router_wl0.1', 'tag':'router_wl0.1', 'host':'192.168.1.1', 'user_host_port':'root@192.168.1.1', 'critical':True, 'cmd_timeout':2, 'check_interval':1, 'rest_of_line':'wl0.1'})
