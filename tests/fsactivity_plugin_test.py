...
dotest (9, "Known host, unavailable - setup WARNING",
        {'key':'Activity_Unavailable_host', 'tag':'Unavailable_host', 'host':'testhostX', 'user_host_port':'me@testhostX', 'critical':True, 'cmd_timeout':2, 'check_interval':1, 'rest_of_line':'1h /mnt/RAMDRIVE/xxx'})
