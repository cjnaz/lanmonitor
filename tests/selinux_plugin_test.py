...
dotest (1, "SELinux local - OK",
        {"key":"SELinux_local", "tag":"local", "host":"local", "user_host_port":"local", "critical":True, "check_interval":1, "rest_of_line":"enforcing"})

dotest (2, "SELinux remote not running - ERROR",
        {"key":"SELinux_remote", "tag":"remote", "host":"testhost", "user_host_port":"me@testhost", "critical":False, "check_interval":1, "rest_of_line":"enforcing"})

dotest (3, "SELinux remote not running - CRITICAL",
        {"key":"SELinux_remote_CRIT", "tag":"remote_CRIT", "host":"testhost", "user_host_port":"me@testhost", "critical":True, "check_interval":1, "rest_of_line":"enforcing"})

dotest (4, "SELinux expected badmode - setup ERROR",
        {"key":"SELinux_badmode", "tag":"Shop2", "host":"local", "user_host_port":"local", "critical":True, "check_interval":1, "rest_of_line":"enforcingX"})

dotest (5, "No such host - WARNING",
        {"key":"SELinux_Unknown", "tag":"Unknown", "host":"nosuchhost", "user_host_port":"me@nosuchhost", "critical":True, "check_interval":1, "rest_of_line":"enforcing"})

dotest (6, "Known host, unavailable - WARNING",
        {"key":"SELinux_Unavailable", "tag":"Unavailable", "host":"testhostX", "user_host_port":"me@testhostX", "critical":True, "check_interval":1, "rest_of_line":"enforcing"})
