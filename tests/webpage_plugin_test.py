...
dotest ({"key":"Page_Unknown", "tag":"Unknown", "host":"nosuchhost", "user_host_port":"pi@nosuchhost", "critical":True, "check_interval":1, "rest_of_line":"http://localhost/weewx/ Current Conditions"})

dotest ({"key":"Page_Unavailable", "tag":"Unavailable", "host":"shopcam", "user_host_port":"me@shopcam", "critical":True, "check_interval":1, "rest_of_line":"http://localhost/weewx/ Current Conditions"})
